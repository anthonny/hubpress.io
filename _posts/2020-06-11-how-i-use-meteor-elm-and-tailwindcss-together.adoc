...
So in this post I will explain how I make the two work together and how to add tailwind for the UI part (because I love tailwind too 😍), from scratch.
...
NOTE: For more informations about the installation, please refer to the official documentation here https://www.meteor.com/install
...
NOTE: For more informations about the command create, follow the link https://docs.meteor.com/commandline.html#meteorcreate


=== Add typescript

Adding Typescript is really simple. Just run these two commands
...
Then in the same file, we will add two Meteor methods, one to add a Todo and another to switch the status of a Todo with its ID:
