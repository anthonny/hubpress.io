...
So in this post I'll explain how I make the two work together and how to add tailwind for the UI part (because I love tailwind too 😍), from scratch.
I'll also explain how to link an existing project to Meteor with a Todo app
...
Three weeks ago I was crying because I could not use Elm with Meteor so I started to use it with React and Typescript 😳.
