...
In the folder `meteor-elm-app/packages/elm-app/app`, create an empty `main.css` file (or SCSS if you prefer) that we will use later to add some style in our Elm application.
