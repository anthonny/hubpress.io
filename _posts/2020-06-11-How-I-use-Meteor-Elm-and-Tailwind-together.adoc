...
Here are the command to install Meteor on OSX/Linux and Windows
OSX / Linux
...
Create a tsconfig.json under the folder `meteor-elm-app`
```json
{
    "compilerOptions": {
      /* Basic Options */
...
NOTE: This definition comes from the typescript template provided by Meteor.
I have just removed the support of JSX.

=== Create the file structure

NOTE: We will setup a simple file structure here, for more complexe projects, you should follow the guideline provided by Meteor https://guide.meteor.com/structure.html#javascript-structure
