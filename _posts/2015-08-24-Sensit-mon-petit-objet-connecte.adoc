...
Après avoir créé son compte, on peut suivre un tutoriel permettant de découvrir comment utiliser l'appareil. C'est plutôt bien fait, à chaque étape on doit manipuler le {url-sensit}[Sens'it] et la page de tutorial réagit en fonction.
